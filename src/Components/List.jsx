                                ...
                                books.map((e) =>
                                    ...
                                    <div className="card h-100">
                                        <div className="d-flex justify-content-center">
                                            <a href={`/details?id=${e.id}`}>
                                            <img className="card-img-top mt-2" id="imgcard" src={e.image} alt={e.title} />
                                            </a>
                                            </div>
                                            <div className="card-body p-4">
                                                <div className="text-center">
                                                <Link to={`/details?id=${e.id}`} className='no-underline'>
                                                    <h6 className="fw-bolder">{e.title}</h6>
                                                    </Link>
                                                    <div className="d-flex justify-content-center small text-warning mb-2">
                                                    <Rating rating={e.rating} reviews={e.reviews} />
                                                    </div>
                                                    ${e.price}
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex justify-content-center">
                                                <div className="text-center">
                                                    <a className="btn btn-outline-dark mt-auto me-2" onClick={() => addToCart(e, 1)} id="custom-btn">Add to cart</a>
                                                </div>
                                                <Link to={`/details?id=${e.id}`}>
                                                    <button className='btn btn-secondary' id="custom-btn">View Details</button>
                                                </Link>
                                                </div>
                                            </div>
                                        </div>
